...
JSON_FILE_NAME = "crawled-stock-values.jsonl"
CSV_FILE_NAME = "crawled-stock-values.csv"

# class to export items to json
class MycrawlerJsonExportPipeline(object):
    def __init__(self):
        self.files = {}
...
class MycrawlerCSVExportPipeline(object):
    def __init__(self):
        self.files = {}
